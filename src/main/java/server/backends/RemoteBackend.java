...
public class RemoteBackend extends ProcessBackend {
    public RemoteBackend(int rmiPort) throws IOException, NotBoundException, InterruptedException {
        super(rmiPort);
        startProcess();
    }

    public RemoteBackend(int rmiPort, ClassLoader... classLoaders) throws IOException, NotBoundException, InterruptedException {
